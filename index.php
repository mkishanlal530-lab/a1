...
<head>
  ...
  <title>Haute Artisanal Charcoal Kebabs & Haute Levantine Banquets — Kebabbanquet</title>
  <meta name="description" content="An epicurean banquet celebration of Anatolian and Persian open-hearth grilling, pasture-raised milk-fed lamb, heirloom saffron pilafs, and private salon hospitality at 181 Mercer Street.">
  <link rel="canonical" href="https://kebabbanquet.com/">
...
<body>
  ...
  <header class="site-header">
    <div class="header-container">
      <a href="/" class="brand-logo" aria-label="Kebabbanquet Home">
        <span class="logo-mark">◈</span>
        <span class="logo-text">Kebabbanquet</span>
      </a>
  ...
  <div class="mobile-drawer" id="mobile-drawer" aria-hidden="true">
    <div class="drawer-header">
      <div class="drawer-brand">Kebabbanquet</div>
    ...
    <nav class="drawer-nav" aria-label="Mobile Navigation">
      ...
      <a href="/collection.html" class="drawer-link">Grand Banquet Degustations & Hearth Menus</a>
    ...
    <div class="drawer-footer">
      ...
      <p class="drawer-contact-info">Email: concierge@kebabbanquet.com</p>
    </div>
  </div>
  ...
  <section class="page-hero" style="padding: 6.5rem 1.5rem 5.5rem;">
    <div class="container">
      <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 3.5rem; align-items: center;">
        <div>
          <span class="hero-badge">Haute Gastronomy &bull; Ancestral Charcoal Hearth</span>
          <h1 style="margin-bottom: 1.2rem;">The Apex of Artisanal Charcoal Kebabs & Haute Levantine Banquets</h1>
          <p class="lead" style="margin-bottom: 2rem;">An epicurean banquet celebration of Anatolian and Persian open-hearth grilling, pasture-raised milk-fed lamb, heirloom saffron pilafs, and private salon hospitality at 181 Mercer Street.</p>
        ...
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-lg); border: 1px solid rgba(255,255,255,0.15);">
          <img src="/assets/images/hero_banquet_supper_table.jpg" alt="Kebabbanquet flagship showcase" style="width: 100%; height: auto;">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="grid-2">
        <div>
          ...
          <p>
            At Kebabbanquet, creation is approached not as transient commercial production, but as permanent architectural engineering. From our Manhattan atelier at 181 Mercer Street in SoHo, our master artisans combine century-old European guild traditions with advanced modern kinetic physics.
          </p>
          <p>
        ...
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-md);">
          <img src="/assets/images/grand_feasting_table_spread.jpg" alt="Master artisan examining tolerances at the Mercer Street atelier">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="section-header text-center">
        ...
        <h2>Four Architectural Pillars of Kebabbanquet</h2>
      ...
      <div class="grid-4">
        <div class="pillar-card">
          ...
          <h3>Oak & Binchotan Charcoal Hearth</h3>
          <p>Dual-fuel refractory embers burning at calibrated thermal zones to achieve rapid caramelization without scorching delicate meat juices.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>Pasture-Raised Heritage Cuts</h3>
          <p>Exclusively dry-aged milk-fed lamb, grain-finished prime rib, and free-range poultry seasoned with hand-harvested wild sumac.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>Hand-Forged Broad Swords</h3>
          <p>Artisanal skewering on wide Damascus steel flat swords that conduct core heat inward, ensuring uniform tenderness and succulent moisture.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>Grand Mezze & Saffron Rices</h3>
          <p>Heirloom Persian saffron tachin, wood-fired lavash flatbreads, and cultured sheep milk labneh prepared fresh daily at dawn.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid-3">
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/chef_carving_artisan_dinner_roast.jpg" alt="Chef Carving Artisan Dinner Roast">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/hero_hearth_roast_dinner_feast.jpg" alt="Hero Hearth Roast Dinner Feast">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/highland_communal_roast_banquet.jpg" alt="Highland Communal Roast Banquet">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/herb_crusted_prime_roast_platter.jpg" alt="Herb Crusted Prime Roast Platter">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/pan_seared_ribeye_steak_dinner.jpg" alt="Pan Seared Ribeye Steak Dinner">
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/woodfire_roast_dinner_flatbread.jpg" alt="Woodfire Roast Dinner Flatbread">
    ...
    <div class="container">
      <div class="grid-2">
        <div>
          ...
          <h2>Ancestral Smoke Chemistry & Terroir Spices</h2>
          <p>We source single-origin spices directly from smallholder farms in Gaziantep and Isfahan: cold-ground wild sumac, sun-dried Urfa biber, and certified Sargol saffron threads.</p>
          <p>Our skewers are hand-forged by master blacksmiths from heavy culinary steel, designed to transfer heat directly through the marrow of the cut while retaining unctuous interior juices.</p>
          <div class="card-specs" style="border: none; margin: 1.5rem 0;">
            <span>◈ <strong>420°C Hearth Core Intensity</strong></span>
            <span>◈ <strong>Single-Origin Terroir Spices</strong></span>
            <span>◈ <strong>Daily Fresh Lavash Hearth</strong></span>
          </div>
        ...
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-md);">
          <img src="/assets/images/communal_dining_hall.jpg" alt="Material inspection and quality verification at the workshop">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-light">
    <div class="container">
      <div class="grid-2">
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-md);">
          <img src="/assets/images/candlelight_dining_table.jpg" alt="Artisan drafting patterns at 181 Mercer Street">
        </div>
        <div>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Kebabbanquet Bespoke Standard</th>
          ...
          <tbody>
            <tr>
              <td><strong>Hearth Core Sear Intensity</strong></td>
              <td><strong>420°C Radiant Ember Heat</strong></td>
    ...
    <div class="container">
      ...
      <div class="grid-4">
        <div class="step-card">
          ...
          <h3>Advance Salon Reservation</h3>
          <p>Reservations for our grand twelve-course banquet tastings open strictly 30 days in advance via our concierge desk.</p>
        </div>
        <div class="step-card">
          <div class="step-number">02</div>
          <h3>Custom Dietary Coordination</h3>
          <p>Inform our culinary director 48 hours prior regarding halal certifications, gluten sensitivities, or vegetarian mezze preferences.</p>
        </div>
        <div class="step-card">
          <div class="step-number">03</div>
          <h3>Communal Feasting Etiquette</h3>
          <p>Banquets are designed as shared communal feasts served on hand-hammered copper platters in our private dining chambers.</p>
        </div>
        <div class="step-card">
          <div class="step-number">04</div>
          <h3>Cellar Sommelier & Arak Pairings</h3>
          <p>Rare Mediterranean mountain vintages, artisanal craft arak, and infused cold-drip mint teas curated by master sommeliers.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="grid-3">
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/fine_dining_table_setting.jpg" alt="Material Provenance and Fiber Crystallography">
        ...
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/chef_plating_gourmet_pass.jpg" alt="Micro-Engineering Tolerances in Haute Finishing">
        ...
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/gourmet_culinary_entree.jpg" alt="Biomechanical Ergonomics in Bespoke Wear">
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <div class="footer-brand">◈ Kebabbanquet</div>
          <p class="footer-desc">
            The benchmark of artisanal charcoal kebabs & haute levantine banquets. Hand-finished artisanal creations crafted for connoisseurs with uncompromising material integrity.
          </p>
          ...
          <div class="footer-contact-item"><strong>Concierge:</strong> concierge@kebabbanquet.com</div>
        </div>
        <div class="footer-col">
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Kebabbanquet Ltd. All Rights Reserved. Master craft at 181 Mercer Street, New York, NY 10012.</p>
